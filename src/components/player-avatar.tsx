    ...
    switch (variant) {
        ...
        case 'game':
            ...
            if (state === 'answered') {
                ...
                containerClasses += 'ring-gray-400 [&>_*]:opacity-30';
            }
            break;
        case 'winner':
            ...
            >
                {showHintBadge && (
                    <motion.div
                        ...
                        exit={{ scale: 0 }}
                        className="!opacity-100 absolute -top-1 -right-1 z-10 shadow-lg border-2 border-white dark:border-gray-900 rounded-full flex items-center justify-center bg-yellow-400 text-yellow-900 p-1"
                    >
