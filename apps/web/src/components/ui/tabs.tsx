...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-start gap-2 rounded-lg border border-border/60 bg-background/70 p-1 text-muted-foreground shadow-sm backdrop-blur",
      className
    )}
    {...props}
  />
